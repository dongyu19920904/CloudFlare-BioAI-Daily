...
**评分维度**：
1. **权威性（30分）**
   - 官方发布（Recursion/Insilico/DeepMind/NVIDIA BioNeMo等）：30分
   - 知名科技媒体（TechCrunch/The Verge/MIT Tech Review/STAT News等）：25分
   - 知名研究机构（Stanford/MIT/Broad Institute等）：25分
   - 行业KOL/专家：20分
   - 普通媒体/个人博客：10分

2. **影响力（25分）**
   - 行业颠覆性突破（新型 AI 药物获批、重大技术突破）：25分
   - 重要产品更新（主流平台重大新功能）：20分
...
4. **用户关注度（15分）**
   - 热门话题（AlphaFold/AI制药/基因编辑等明星领域）：15分
   - 热门领域（AI诊断、蛋白质设计、药物发现）：12分
   - 垂直领域工具（特定疾病应用）：8分
   - 小众技术/学术研究：5分

5. **视觉内容（10分）** ⭐ **新增：优先选择有图片的信息源**
   - 包含高质量图片或视频：10分
   - 包含普通图片：7分
   - 无图片/视频：0分
   - **重要**：在同等评分下，优先选择有图片的信息源，让日报更生动有趣
...
- **图片优先原则**：在筛选时，尽量确保TOP 10 中至少有 3-5 条包含图片，让日报更生动
